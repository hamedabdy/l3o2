...
function newOverlay(carte, concerts, oms){
    ...
    var _content = '<div class="info-window-body"><span class="helper"></span><img style="max-width: 200px; max-height: 200px;" src="'+concerts.img+'" title="'+concerts.title+'" alt="'+imageAlt+'" onerror="this.src=\'images/noimage.png\'"/><div class="tile-info info-window-info"><div class="tile-title info-window-title" title="'+concerts.title+'">'+title+'</div><div class="tile-body"><b>Artists: </b><span>'+artists+'</span><br><b>Date: </b>'+date+'<br><span>'+concerts.address+'</span></div><div class="shareBtns">'+share.fb_share+share.tw_share+share.gplus+share.su+share.extLink+'</div></div></div>';
